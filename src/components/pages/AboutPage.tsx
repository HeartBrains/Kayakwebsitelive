...
export function AboutPage({ onNavigate, activePage = 'about' }: AboutPageProps) {
  ...
  const contentEN = [
    `Art Forest is a new paradigm of institution whose name “SilaPaa” stems from two Thai words, Silapa and Paa meaning Art and Forest respectively, reflecting the institution’s ambition: advancing, supporting, and realising visionary proposals of artists in the natural environment.`,
    `Art Forest enables artists to realise visionary projects within nature that may be unattainable due to scale or scope. It achieves this through commissioning single artist projects, organising exhibitions, creating site-specific installations, and collecting the work of Thai and International artists focusing on healing nature. To heal is to recover. Beyond the practice of well-being and more than the already established mindfulness activities in nature, Art Forest recovers the lost possibilities, complexities, and vitalities of nature through the art of living, making, practising and thinking, not about but with nature.`,
    `From its inception, Art Forest has shown a commitment to following and supporting artists' ideas that contribute to challenge and enrich the relationship with Nature. Through the Research and Public Programme such as talks, workshops, and symposiums, we share values, alter perspectives, and learn and unlearn together. Knowledge is exchanged across a wide range of ages, backgrounds, intellectual interests, disciplines, and nationalities in this transversal milieu.`,
  ...
  const contentTH = [
    `Art Forest คือกระบวนทัศน์ใหม่ของสถาบันที่ชื่อว่า “ศิลปะป่า” มาจากคำไทยสองคำคือ ศิลปะ และ ป่า สะท้อนถึงความมุ่งมั่นของสถาบันในการผลักดัน สนับสนุน และทำให้ข้อเสนอที่มีวิสัยทัศน์ของศิลปินในสภาพแวดล้อมทางธรรมชาติเป็นจริง`,
    `Art Forest ช่วยให้ศิลปินสามารถดำเนินโครงการที่มีวิสัยทัศน์ท่ามกลางธรรมชาติ ซึ่งอาจทำได้ยากเนื่องจากขนาดหรือขอบเขต โดยทำผ่านการว่าจ้างโครงการศิลปินเดี่ยว การจัดนิทรรศการ การสร้างสรรค์ผลงานศิลปะจัดวางเฉพาะพื้นที่ และการสะสมผลงานของศิลปินไทยและนานาชาติที่มุ่งเน้นการเยียวยาธรรมชาติ การเยียวยาคือการฟื้นฟู นอกเหนือจากการฝึกฝนเพื่อสุขภาวะและกิจกรรมการเจริญสติในธรรมชาติที่มีอยู่แล้ว Art Forest ฟื้นฟูความเป็นไปได้ ความซับซ้อน และพลังชีวิตที่สูญหายไปของธรรมชาติ ผ่านศิลปะแห่งการใช้ชีวิต การสร้างสรรค์ การฝึกฝน และการคิด ไม่ใช่เกี่ยวกับธรรมชาติ แต่ร่วมกับธรรมชาติ`,
    `นับตั้งแต่ก่อตั้ง Art Forest ได้แสดงความมุ่งมั่นในการติดตามและสนับสนุนความคิดของศิลปินที่มีส่วนช่วยท้าทายและเสริมสร้างความสัมพันธ์กับธรรมชาติ ผ่านโครงการวิจัยและสาธารณะ เช่น การเสวนา เวิร์กช็อป และการประชุมสัมมนา เราแบ่งปันค่านิยม ปรับเปลี่ยนมุมมอง เรียนรู้และละทิ้งความรู้เดิมร่วมกัน ความรู้จะถูกแลกเปลี่ยนข้ามช่วงวัย ภูมิหลัง ความสนใจทางปัญญา สาขาวิชา และสัญชาติในสภาพแวดล้อมที่หลากหลายนี้`,
    `นับตั้งแต่การก่อตั้ง Art Forest ได้เปลี่ยนพื้นที่เขาใหญ่ให้เป็นจุดหมายปลายทางทางศิลปะที่มีชีวิตชีวาสำหรับผู้มาเยือนจากในภูมิภาคและระดับนานาชาติ`
  ];
